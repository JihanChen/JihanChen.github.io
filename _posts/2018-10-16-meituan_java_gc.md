...
本文转载自 [美团技术团队博客](https://tech.meituan.com/jvm_optimize.html) 
...
![GC影响](https://tech.meituan.com/img/JVM-optimize/JVMpart.png)
...
![GC影响](https://tech.meituan.com/img/JVM-optimize/GCgs.png)
...
![GC影响](https://tech.meituan.com/img/JVM-optimize/YGCtime.png)
...
![GC影响](https://tech.meituan.com/img/JVM-optimize/log1.png)
...
调整前：![GC影响](https://tech.meituan.com/img/JVM-optimize/before.png)

调整后：![GC影响](https://tech.meituan.com/img/JVM-optimize/after.png)
...
![GC影响](https://tech.meituan.com/img/JVM-optimize/Remark.png)
...
![GC影响](https://tech.meituan.com/img/JVM-optimize/four.png)

可见，Remark阶段主要是通过扫描堆来判断对象是否存活。那么准确判断对象是否存活，需要扫描哪些对象？CMS对老年代做回收，Remark阶段仅扫描老年代是否可行？结论是不可行，原因如下：
![GC影响](https://tech.meituan.com/img/JVM-optimize/cross.png)
...
![GC影响](https://tech.meituan.com/img/JVM-optimize/2after.png)
...
![GC影响](https://tech.meituan.com/img/JVM-optimize/YGCcross.png)
...
![GC影响](https://tech.meituan.com/img/JVM-optimize/PermGC.png)
